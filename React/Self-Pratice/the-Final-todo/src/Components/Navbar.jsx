...
const Navbar = () => {
  ...
  return (
    <div className="navbar border-b-2  dark:border-gray-700 light: border-rose-500">
      <ul className="flex gap-5 items-center justify-between px-4 md:px-8 m-4 font-bold text-2xl">
        <li>
          <NavLink
            to="/home"
